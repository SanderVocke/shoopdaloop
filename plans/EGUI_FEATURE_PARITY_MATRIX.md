...
| XLUA-REMOVE-001 | Workspace-wide former-runtime removal | Manifests, Rust, metadata, lockfile, trees, release archive, and packaged Wasm scans contain only omniLua's pure-Rust chain | Explored for omniLua migration | Required | Complete | Source/dependency/package scans pass; final workspace rerun is tracked by E2E closure |
