...
| TRACK-007 | Dry/wet Add Track choices | QML supports external and Carla processing with dry/wet audio/MIDI topology. | Explored for dry/wet/Carla | Dry/wet/Carla required | In progress | Stages 0–1 of `EGUI_DRY_WET_AND_CARLA_TRACKS_PLAN.md`: typed processor contracts plus native External creation, role-bearing loops/ports, routing, capture/replacement, and application acceptance are complete; capability-driven egui and Carla remain |
...
| CONN-DEF-003 | Dry/wet send/return topology and FX chains | QML dry/wet tracks supply send/return categories. | Explored for dry/wet/Carla | Dry/wet/Carla required | In progress | Native External now publishes and restores exact Audio in/send/return/out and MIDI in/send roles and links; internal Carla composition remains Stage 2 of `EGUI_DRY_WET_AND_CARLA_TRACKS_PLAN.md` |
...
| FX-SUBPROC-006 | Pure-egui FX integration | FX chains and dry/wet tracks were deferred. | Explored for dry/wet/Carla | In progress | Stages 0–1 contracts and native External dry/wet topology are implemented; native Carla, capability-driven egui, persistence, and settings follow the active plan |
