...
| IO-CHAN-001 | Arbitrary channels per loop | `u32` format/API counts; no old 10-channel persistence ceiling | Explored for M5 | M5 required | Complete | 300-channel codec, 12-channel app session, `u32` backend/protocol, custom-channel UI tests |
