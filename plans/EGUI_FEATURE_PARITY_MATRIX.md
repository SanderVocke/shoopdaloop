...
| TRACK-007 | Dry/wet Add Track choices | QML supports external and Carla processing with dry/wet audio/MIDI topology. | Explored for dry/wet/Carla | Dry/wet/Carla required | In progress | `EGUI_DRY_WET_AND_CARLA_TRACKS_PLAN.md`; Stage 0 adds typed processor capabilities, topology, lifecycle facets, browser-empty catalogs, and validation contracts |
...
| CONN-DEF-003 | Dry/wet send/return topology and FX chains | QML dry/wet tracks supply send/return categories. | Explored for dry/wet/Carla | Dry/wet/Carla required | In progress | Role model/preview support is complete; native External topology is Stage 1 of `EGUI_DRY_WET_AND_CARLA_TRACKS_PLAN.md` |
...
| FX-SUBPROC-006 | Pure-egui FX integration | FX chains and dry/wet tracks were deferred. | Explored for dry/wet/Carla | In progress | Stage 0 contracts are implemented; native topology/Carla, capability-driven egui, persistence, and settings follow the active plan |
