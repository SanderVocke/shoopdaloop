...
| LUA-KEY-001 | Keyboard press/release bridge | Qt key/modifier constants, no repeat, and release-sensitive sampler behavior | Explored for Lua milestone | Required | Partial | All retained numeric constants, typed key intents, and application-to-Lua callback delivery pass; raw egui translation/focus/repeat handling and production keyboard workflow remain open |
