...
| CLICK-XTARGET-001 | Native/browser resources, preview, and artifacts | Legacy is native/resource-directory based; replacement must compile assets into every product target | Explored for click tracks | Click-track required | Partial | Debug native/hosted/self-contained packages verify all four compiled markers; native workflow and Chrome/Firefox/self-contained production runs pass; release/full dependency closure remains Stage 4 |
