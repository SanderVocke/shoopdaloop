...
| LUA-PRES-001 | Native egui script manager | Add, enable, stop, restart, forget, help, status, errors, listening, and MIDI diagnostics | Explored for Lua milestone | Required | Complete | Plain immutable state, typed stable-ID intents, lifecycle/actions/help/log/callback/timer/MIDI presentation, browser-unavailable state, and GUI interaction tests pass |
