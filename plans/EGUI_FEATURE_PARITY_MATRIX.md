...
| LUA-LIFE-001 | Isolated start/stop/restart/status | Each script can finish or remain listening; destruction removes its callbacks and MIDI rules | Explored for Lua milestone | Required | Partial | Stable IDs, source loading, lifecycle/error snapshots, actor commands, restart/stop/forget, and isolation tests pass; callback/MIDI-owned teardown remains open |
