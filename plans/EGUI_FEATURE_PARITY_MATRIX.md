...
| XLUA-FRONTEND-001 | Retained frontend/QML on omniLua | Frontend engine, conversions, callbacks, ownership, session control, and MIDI bridges compile directly against omniLua; focused Rust tests pass | Explored for omniLua migration | Required | In progress | Complete retained Lua/QML behavior suite and lifecycle cleanup on omniLua remain required |
