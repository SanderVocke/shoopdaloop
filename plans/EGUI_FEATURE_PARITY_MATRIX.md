...
| WMIDI-E2E-001 | Production artifact and browser closure | Browser artifacts intentionally had no physical MIDI | Explored for Web MIDI | Required | Complete | Debug/release hosted and self-contained Chrome track/control/session/hotplug/restart workflows pass, including denial/retry, open/send failure visibility, saturation recovery, and callback continuity; 1,203-test workspace, 236/236 QML, Firefox no-host regression, package/import/dependency scans, and debug/release artifacts pass |
