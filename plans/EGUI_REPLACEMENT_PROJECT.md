...
| egui MIDI piano | In progress | `EGUI_MIDI_PIANO_PLAN.md` delivers the typed lifecycle contract, full-range geometry, shared driver-independent protocol-v5 input staging, authoritative monitored role-bearing fanout, original-recipient release, and partial-failure cleanup with exact two-track engine recording evidence. Pane integration and egui product workflows remain staged. |
