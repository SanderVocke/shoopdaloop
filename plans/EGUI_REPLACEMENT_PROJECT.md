...
| Cross-target ports, browser Lua, and omniLua migration | In progress | The workspace, shared scripting crate, and retained frontend/QML bridge now use pinned omniLua 0.7.1. Native scripting, frontend Rust tests, and all Lua-specific retained QML self-tests pass; the shared crate compiles for Wasm without native MIDI, and former C Lua dependencies are absent from manifests/lockfile/trees. Browser execution, package scans, port normalization, and mutable Web Audio routing remain open. |
