...
| Click-track generated media | Planned | `EGUI_CLICK_TRACK_GENERATION_PLAN.md` specifies embedded audio/MIDI generation, loop-length fitting, non-mutating preview, transactional target-loop replacement, and native/browser evidence while reusing the session/media boundary. |
