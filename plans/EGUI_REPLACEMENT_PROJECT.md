...
| egui MIDI piano | In progress | `EGUI_MIDI_PIANO_PLAN.md` freezes typed press/release/release-all actions, full 0–127 geometry, scientific C labels, and C4 centering. Driver-independent input staging, application fanout/lifecycle, pane integration, and cross-target evidence remain staged. |
