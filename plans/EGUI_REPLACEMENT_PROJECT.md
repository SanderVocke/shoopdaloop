...
| egui MIDI piano | In progress | `EGUI_MIDI_PIANO_PLAN.md` freezes typed press/release/release-all actions, full 0–127 geometry, scientific C labels, and C4 centering. Shared bounded dummy/external/native input staging and protocol-v5 AudioWorklet injection are driver-independent with accepted process-iteration timing; application fanout/lifecycle, pane integration, and product evidence remain staged. |
