...
class SLLooperManager(QObject):
    ...
    slLooperIndicesChanged = pyqtSignal(list)
    ...
    @pyqtProperty(int, notify=slLooperIndicesChanged)
    def sl_looper_indices(self):
        return self._sl_looper_indices

    @sl_looper_indices.setter
    def sl_looper_indices(self, i):
        if self._sl_looper_indices != i:
            self._sl_looper_indices = i
            self.slLooperIndicesChanged.emit(i)
