...
function generate_default_track(name, n_loops, id) {
    var audio_l_ports = [
    ...
    for (var i=0; i<n_loops; i++) {
        ...
        var loop = generate_loop(id+'_loop_'+ii, 0, false, [
...
function generate_default_session() {
    var master_track = generate_default_track("Master", 1, 'master_loop')
    var first_track = generate_default_track("Track 1", 8, 'track_1')
