...
| M3-AUDIO-002 | Microphone permission and secure-context lifecycle | No browser media permission or physical device was requested. | Explored for M3 | M3 required | Complete | Chrome grant, deny/retry, repeated start, suspend, media-track end/retry, forced failure/retry, zero-owned-track shutdown, explicit offline, and direct-file limitation tests |
