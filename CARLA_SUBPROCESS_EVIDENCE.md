...
The only open evidence in this audit is native Windows/macOS execution and measurement. Linux-only compilation or timing is not used to satisfy those rows. The current all-platform evidence run is [GitHub Actions run 31127629893](https://github.com/SanderVocke/shoopdaloop/actions/runs/31127629893) for commit `70060bd5`; it is queued behind the active August 6, 2026 GitHub Actions service incident and is not evidence until it completes successfully.
