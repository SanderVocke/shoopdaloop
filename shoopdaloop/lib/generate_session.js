function generate_audio_port(id, passthrough_to_ids, name_parts, direction, volume, muted, passthrough_muted) {
    return {
        'id': id,
...
function generate_midi_port(id, passthrough_to_ids, name_parts, direction, muted, passthrough_muted) {
    return {
        'id': id,
        'passthrough_to': passthrough_to_ids,
        'schema': 'midiport.1',
...
function generate_default_session(app_version, n_loops_in_master_track=1) {
    var master_track = generate_default_track("Master", n_loops_in_master_track, 'master', true, 'master_loop', 0, 0, 1, false, false, false, undefined)
