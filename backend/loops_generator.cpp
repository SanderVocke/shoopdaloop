...
public:
    ...
    void generate() {
        ...
        // More debug prints
        // generates_soft_sync_at_expr = print_when(is_starting_to_play || will_play_beyond_end, generates_soft_sync_at_expr, "is soft sync generated by", loop);
        // Func
        ...
        Expr will_wrap =
            will_play_to_end && (!is_soft_synced_to_other || will_receive_soft_sync);
        Expr will_wrap_from =
            select (
                is_soft_synced_to_other,
