...
public:
    ...
    virtual std::optional<size_t> PROC_predicted_next_trigger_eta() const = 0;
    ...
    virtual void            plan_transition(loop_mode_t mode, size_t n_cycles_delay = 0, bool wait_for_sync = true, bool thread_safe = true) = 0;
