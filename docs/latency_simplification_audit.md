...
| Final production/documentation | 47 | 6,526 | 213 | 6,739 |
| Final integration tests/examples | 2 | 48 | 2 | 50 |

The simplification delta itself is 5,009 additions and 19,782 deletions across 77
...
| 9 | reduced app/backend/wire structs, delta-based per-channel take control, track-menu UI test, screenshot, and removed-symbol searches |
