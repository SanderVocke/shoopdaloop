...
Session {
    ...
    ShoopSessionTestCase {
        ...
        function test_drywet_record_no_monitor() {
            start_test_fn('test_drywet_record_no_monitor')
            check_backend()
            reset()
            ...
            end_test_fn('test_drywet_record_no_monitor')
        }

        function test_drywet_record_monitor() {
            start_test_fn('test_drywet_record_monitor')
            check_backend()
            reset()
            ...
            end_test_fn('test_drywet_record_monitor')
        }

        function test_drywet_play_no_monitor() {
            start_test_fn('test_drywet_play_no_monitor')
            check_backend()
            reset()
            tut_control().monitor = false
            tut_control().mute = false
            ...
            end_test_fn('test_drywet_play_no_monitor')
        }

        function test_drywet_play_monitor() {
            start_test_fn('test_drywet_play_monitor')
            check_backend()
            reset()
            tut_control().monitor = true
            tut_control().mute = false
            ...
            end_test_fn('test_drywet_play_monitor')
        }

        function test_drywet_playdry_no_monitor() {
            start_test_fn('test_drywet_playdry_no_monitor')
            check_backend()
            reset()
            tut_control().monitor = false
            tut_control().mute = false
            ...
            testcase.logger.info(
                `${l.any_loop_playing_dry} ${l.disable_fx} ${fx.active}`
            )
            ...
            end_test_fn('test_drywet_playdry_no_monitor')
        }

        function test_drywet_playdry_monitor() {
            start_test_fn('test_drywet_playdry_monitor')
            check_backend()
            reset()
            tut_control().monitor = true
            tut_control().mute = false
            ...
            end_test_fn('test_drywet_playdry_monitor')
        }

        function test_drywet_rerecord_no_monitor() {
            start_test_fn('test_drywet_rerecord_no_monitor')
            check_backend()
            reset()
            tut_control().monitor = false
            tut_control().mute = false
            ...
            end_test_fn('test_drywet_rerecord_no_monitor')
        }

        function test_drywet_rerecord_monitor() {
            start_test_fn('test_drywet_rerecord_monitor')
            check_backend()
            reset()
            tut_control().monitor = true
            tut_control().mute = false
            ...
            verify_eq(dry1, [50, 60, 70, 80])
            verify_eq(dry2, [80, 70, 60, 50])
            verify_eq(wet1, [51, 62, 73, 84])
            verify_eq(wet2, [84, 73, 62, 51])

            end_test_fn('test_drywet_rerecord_monitor')
        }
    }
}