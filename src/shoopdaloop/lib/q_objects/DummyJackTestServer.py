...
class DummyJackTestServer(QQuickItem):
    def __init__(self, parent=None):
        ...
        self.jackd = subprocess.Popen('jackd -T -r -n {} -d dummy -C 0 -P 0 --rate 1024 --period 128'.format(self._server_name), shell=True, preexec_fn = set_pdeathsig(signal.SIGTERM))
