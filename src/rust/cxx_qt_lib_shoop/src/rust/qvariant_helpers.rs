...
mod ffi {
    unsafe extern "C++" {
        ...
        type QSharedPointer_QVector_QVariant =
            crate::qsharedpointer_qvector_qvariant::QSharedPointer_QVector_QVariant;
        ...
        #[rust_name = "qvariant_convertible_to_qvector_f32"]
        unsafe fn qvariantConvertibleTo(obj: &QVariant, example: *mut QVector_f32) -> Result<bool>;

        #[rust_name = "qvariant_to_qvector_f32"]
        unsafe fn qvariantAs(variant: &QVariant, example: *mut QVector_f32) -> Result<QVector_f32>;

        #[rust_name = "qvector_f32_to_qvariant"]
        unsafe fn asQVariant(obj: &QVector_f32) -> Result<QVariant>;

        #[rust_name = "qvariant_convertible_to_qvector_qvariant"]
        unsafe fn qvariantConvertibleTo(
            obj: &QVariant,
            example: *mut QVector_QVariant,
        ) -> Result<bool>;

        #[rust_name = "qvariant_to_qvector_qvariant"]
        unsafe fn qvariantAs(
            variant: &QVariant,
            example: *mut QVector_QVariant,
        ) -> Result<QVector_QVariant>;

        #[rust_name = "qvector_qvariant_to_qvariant"]
        unsafe fn asQVariant(obj: &QVector_QVariant) -> Result<QVariant>;
        ...
        #[rust_name = "qvariant_convertible_to_qlist_u8"]
        unsafe fn qvariantConvertibleTo(obj: &QVariant, example: *mut QList_u8) -> Result<bool>;

        #[rust_name = "qvariant_to_qlist_u8"]
        unsafe fn qvariantAs(variant: &QVariant, example: *mut QList_u8) -> Result<QList_u8>;

        #[rust_name = "qlist_u8_to_qvariant"]
        unsafe fn asQVariant(obj: &QList_u8) -> Result<QVariant>;
        ...
        #[rust_name = "qvariant_convertible_to_qsharedpointer_qvector_qvariant"]
        unsafe fn qvariantConvertibleTo(
            obj: &QVariant,
            example: *mut QSharedPointer_QVector_QVariant,
        ) -> Result<bool>;

        #[rust_name = "qvariant_to_qsharedpointer_qvector_qvariant"]
        unsafe fn qvariantAsUniquePtr(
            variant: &QVariant,
            example: *mut QSharedPointer_QVector_QVariant,
        ) -> Result<UniquePtr<QSharedPointer_QVector_QVariant>>;

        #[rust_name = "qsharedpointer_qvector_qvariant_to_qvariant"]
        unsafe fn asQVariant(obj: &QSharedPointer_QVector_QVariant) -> Result<QVariant>;
...
pub fn qvariant_convertible_to_qvector_f32(obj: &QVariant) -> Result<bool, cxx::Exception> {
    unsafe { ffi::qvariant_convertible_to_qvector_f32(obj, std::ptr::null_mut()) }
}

pub fn qvariant_to_qvector_f32(obj: &QVariant) -> Result<QVector_f32, cxx::Exception> {
    unsafe { ffi::qvariant_to_qvector_f32(obj, std::ptr::null_mut()) }
}

pub fn qvector_f32_to_qvariant(obj: &QVector_f32) -> Result<QVariant, cxx::Exception> {
    unsafe { ffi::qvector_f32_to_qvariant(obj) }
}

pub fn qvariant_convertible_to_qvector_qvariant(obj: &QVariant) -> Result<bool, cxx::Exception> {
    unsafe { ffi::qvariant_convertible_to_qvector_qvariant(obj, std::ptr::null_mut()) }
}

pub fn qvariant_to_qvector_qvariant(obj: &QVariant) -> Result<QVector_QVariant, cxx::Exception> {
    unsafe { ffi::qvariant_to_qvector_qvariant(obj, std::ptr::null_mut()) }
}

pub fn qvector_qvariant_to_qvariant(obj: &QVector_QVariant) -> Result<QVariant, cxx::Exception> {
    unsafe { ffi::qvector_qvariant_to_qvariant(obj) }
}
...
pub fn qvariant_convertible_to_qlist_u8(obj: &QVariant) -> Result<bool, cxx::Exception> {
    unsafe { ffi::qvariant_convertible_to_qlist_u8(obj, std::ptr::null_mut()) }
}

pub fn qvariant_to_qlist_u8(obj: &QVariant) -> Result<QList_u8, cxx::Exception> {
    unsafe { ffi::qvariant_to_qlist_u8(obj, std::ptr::null_mut()) }
}

pub fn qlist_u8_to_qvariant(obj: &QList_u8) -> Result<QVariant, cxx::Exception> {
    unsafe { ffi::qlist_u8_to_qvariant(obj) }
}
...
pub fn qvariant_convertible_to_qsharedpointer_qvector_qvariant(
    obj: &QVariant,
) -> Result<bool, cxx::Exception> {
    unsafe {
        ffi::qvariant_convertible_to_qsharedpointer_qvector_qvariant(obj, std::ptr::null_mut())
    }
}

pub fn qvariant_to_qsharedpointer_qvector_qvariant(
    obj: &QVariant,
) -> Result<cxx::UniquePtr<QSharedPointer_QVector_QVariant>, cxx::Exception> {
    unsafe { ffi::qvariant_to_qsharedpointer_qvector_qvariant(obj, std::ptr::null_mut()) }
}

pub fn qsharedpointer_qvector_qvariant_to_qvariant(
    obj: &QSharedPointer_QVector_QVariant,
) -> Result<QVariant, cxx::Exception> {
    unsafe { ffi::qsharedpointer_qvector_qvariant_to_qvariant(obj) }
}
