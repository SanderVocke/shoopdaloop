...
mod ffi {
    unsafe extern "C++" {
        ...
        #[rust_name = "qsharedpointer_qvector_f32_from_ptr_delete_later"]
        unsafe fn qSharedPointerQVectorf32FromPtrDeleteLater(
            ptr: *mut QVector_f32,
...
impl QSharedPointer_QVector_f32 {
    pub fn from_ptr_delete_later(
        ...
        unsafe { ffi::qsharedpointer_qvector_f32_from_ptr_delete_later(ptr) }
    }
