...
pub const MODIFIER_CONSTANTS: &[(&str, i64)] = &[
    ...
    ("KeyModifier_AltModifier", 134217728),
    ("KeyModifier_MetaModifier", 268435456),
    ("KeyModifier_KeypadModifier", 536870912),
    ("KeyModifier_GroupSwitchModifier", 1073741824),
    ("KeyModifier_KeyboardModifierMask", 4261412864),
];
