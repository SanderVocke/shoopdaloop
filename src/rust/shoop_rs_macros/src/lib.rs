...
use quote::quote;
use syn::{parse_macro_input, ItemFn, Signature, FnArg};
...
pub fn deny_calls_not_on_object_thread(args: TokenStream, input: TokenStream) -> TokenStream { return thread_check(args, input, true); }

#[proc_macro_attribute]
pub fn deny_calls_on_object_thread(args: TokenStream, input: TokenStream) -> TokenStream { return thread_check(args, input, false); }
