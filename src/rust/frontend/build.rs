...
fn main() {
    ...
    unsafe {
        CxxQtBuilder::new()
            ...
            .file("src/cxx_qt_shoop/rust/qobj_logger_bridge.rs")
            ...
            .file("src/cxx_qt_shoop/rust/qobj_frontend_refresh_bridge.rs")
            ...
            .cpp_file("src/cxx_qt_shoop/include/cxx-qt-shoop/ShoopQmlEngine.h")
            .cpp_file("src/cxx_qt_shoop/include/cxx-qt-shoop/ShoopKeyEventParser.h")
            .build()
            .reexport_dependency("cxx-qt-lib-shoop")
