...
pub mod ffi {
    ...
    unsafe extern "RustQt" {
        #[qobject]
        #[qproperty(*mut ShoopQObject, testcase_runner)]
    ...
    unsafe extern "C++" {
        ...
        unsafe fn make_raw_with_one_arg(parent: *mut ShoopQObject) -> *mut TestFileRunner;

        include!("cxx-qt-lib-shoop/qobject.h");
        #[rust_name = "test_runner_qobject_from_ptr"]
        unsafe fn qobjectFromPtr(obj: *mut TestFileRunner) -> *mut ShoopQObject;

        #[rust_name = "test_runner_qobject_from_ref"]
        fn qobjectFromRef(obj: &TestFileRunner) -> &ShoopQObject;
    }
}
...
impl AsQObject for ffi::TestFileRunner {
    ...
    unsafe fn ref_qobject_ptr(&self) -> *const ffi::ShoopQObject {
        ffi::test_runner_qobject_from_ref(self) as *const ffi::ShoopQObject
    }
}
...
pub struct TestFileRunnerRust {
    ...
    pub testcase_runner: *mut ffi::ShoopQObject,
