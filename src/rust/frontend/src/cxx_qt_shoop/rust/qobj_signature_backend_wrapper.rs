    ...
    T: invokable::QObjectOrConvertible,
{
    ...
    invokable::invoke(
        obj,
        constants::INVOKABLE_FIND_EXTERNAL_PORTS.to_string(),
        connection_type,
        &args,
    )
}

pub fn invoke_dummy_request_controlled_frames<T>(
    obj: &mut T,
    connection_type: u32,
    n_frames: i32,
) -> Result<(), Exception>
    ...
    T: invokable::QObjectOrConvertible,
{
    invokable::invoke(
        obj,
        constants::INVOKABLE_DUMMY_REQUEST_CONTROLLED_FRAMES.to_string(),
        connection_type,
        &(n_frames),
    )
}
    ...
    T: invokable::QObjectOrConvertible,
{
    invokable::invoke(
        obj,
        constants::INVOKABLE_WAIT_PROCESS.to_string(),
        connection_type,
        &(),
    )
}
