...
pub fn create_py_module<'py>(
    ...
    m.add_function(wrap_pyfunction!(objects::shoop_rust_transition_gui_loop, &m)?)?;
    m.add_function(wrap_pyfunction!(objects::shoop_rust_transition_gui_loops, &m)?)?;
    m.add_function(wrap_pyfunction!(objects::shoop_rust_transition_backend_loop, &m)?)?;
    m.add_function(wrap_pyfunction!(objects::shoop_rust_transition_backend_loops, &m)?)?;
