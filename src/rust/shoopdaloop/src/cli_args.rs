...
pub struct CliArgs {
    ...
    #[clap(short = 'b', long = "backend", default_value = "jack")]
    pub backend: String,
    ...
    /// This captures all arguments that come after a `--` separator. See --qml-self-test for how they are used.
...
pub struct DeveloperOptions {
    ...
    #[clap(
        short = 'm',
        long = "main",
        default_value = "shoopdaloop_main",
