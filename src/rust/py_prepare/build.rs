...
fn main_impl() -> Result<(), anyhow::Error> {
    ...
    #[cfg(not(feature = "prebuild"))]
    {
        ...
        println!("cargo:rustc-env=SHOOP_BUILD_VENV_DIR={}", build_venv_dir.to_str().unwrap());
        println!("cargo:rustc-env=SHOOP_BUILD_VENV_PYTHON={}", build_venv_python.to_string_lossy());
