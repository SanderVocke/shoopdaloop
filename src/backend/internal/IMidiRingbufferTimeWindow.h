 ...
 * 
 * This interface isolates the time-window logic (n_samples tracking, next_buffer, put, snapshot)
 * so it can be easily bridged to Rust independently of the storage core.
 */
...
public:
    ...
    // Snapshot (copies current state to target storage)
