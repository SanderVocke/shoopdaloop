    ...
    Backend {
        ...
        ShoopTestCase {
            ...
            test_fns: ({
                ...
                'test_autoconnect_internal_out_external_in_ignore_empty': () => {
                    backend.dummy_remove_all_external_mock_ports();
                ...
                'test_autoconnect_internal_out_external_in_ignore_partialmatch': () => {
                    backend.dummy_remove_all_external_mock_ports();
                ...
                'test_autoconnect_internal_out_external_in_ignore_partialmatch2': () => {
                    backend.dummy_remove_all_external_mock_ports();
