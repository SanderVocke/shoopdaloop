...
struct PassthroughMixingTestChain : public ModuleLoggingEnabled<"Test.PassthroughMixingTestChain"> {
    ...
    std::shared_ptr<GraphPort> int_input_port_1;
    DummyAudioPort* int_dummy_input_port_1;

    shoopdaloop_audio_port_t *api_input_port_2;
    std::shared_ptr<GraphPort> int_input_port_2;
    ...
    std::shared_ptr<GraphPort> int_mixing_port;
    ...
    PassthroughMixingTestChain() {
        ...
        api_input_port_1 = open_driver_audio_port(api_backend_session, api_driver, "sys_audio_in_1", ShoopPortDirection_Input);
        ...
        api_input_port_2 = open_driver_audio_port(api_backend_session, api_driver, "sys_audio_in_2", ShoopPortDirection_Input);
        ...
        api_mixing_port = open_internal_audio_port(api_backend_session, "audio_mix");
