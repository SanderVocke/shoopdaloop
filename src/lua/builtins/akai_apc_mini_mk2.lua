-- akai_apc_mini_mk1.lua: Deep integration for the Akai APC Mini MK2.
--
...
shoop_control.auto_open_device_specific_midi_control_output(".*APC mini mk2.*", on_output_port_opened, on_output_port_connected, 1000)
shoop_control.auto_open_device_specific_midi_control_input(".*APC mini mk2.*", on_midi_in)
