...
- Native, hosted-web, and single-file web artifacts contain the complete built-ins tree with directory structure, Markdown, and images preserved. The single-file artifact serves its embedded immutable copy through the browser catalog adapter.
